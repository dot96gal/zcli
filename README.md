...
```sh
zig fetch --save https://github.com/dot96gal/zcli/archive/<commit-or-tag>.tar.gz
```
...
.dependencies = .{
    .zcli = .{
        .url = "https://github.com/dot96gal/zcli/archive/<commit-or-tag>.tar.gz",
